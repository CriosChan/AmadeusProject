...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //If the user wakes up Kurisu between 11:15 p.m. and 07:00 a.m.
        ...
        Log.i("[CURRENT TIME]", currentTime + currentTimeInt);

        if (currentTimeInt >= 211500 || currentTimeInt <= 070000){
            Amadeus.speak(voiceLines[VoiceLine.Line.IT_IS_LATE], MainActivity.this);
