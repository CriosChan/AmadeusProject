...
class VoiceLine {
    ...
    static class Line {
        static VoiceLine[] voiceLines = new VoiceLine[46];
        ...
        static final int IT_IS_LATE = 45;
        ...
        static VoiceLine[] getLines() {
            ...
            voiceLines[IT_IS_LATE] = new VoiceLine(R.raw.hello, Mood.ANGRY, R.string.Line_it_is_late);
